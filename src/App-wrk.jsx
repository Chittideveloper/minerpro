    ...
    <>
      ...
      <div className="relative w-full min-h-screen overflow-hidden flex flex-col"
        ...
        <div className="relative z-20 flex flex-wrap items-center justify-between gap-2 px-4 sm:px-8 py-3"
          ...
          <a href="https://transglobalgeomatics.com/" target="_blank" rel="noopener noreferrer" className="m-0"><span className="text-white/90 text-[9px] tracking-widest uppercase" style={{ fontFamily: "'Rajdhani',sans-serif" }}>
